            ...
            <form action="{{ route('public-register') }}" method="POST">
                ...
                <div class="form-group local-forms">
                    ...
                    <select class="form-control select @error('role_name') is-invalid @enderror" name="role_name"
                        ...
                        @if ($customerRole && $customerRole->role_type === 'Client End-User')
                            <option value="{{ $customerRole->role_type }}">{{ $customerRole->role_type }}</option>
                        @endif
                    </select>
                    @error('role_name')
                ...
                <div class=" dont-have">Already Have Account? <a href="{{ route('login') }}">Login</a></div>
