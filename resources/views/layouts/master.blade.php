...
<head>
    ...
    <!-- Favicons -->
    <link href="{{ URL::to('assets/img/favicon copy.png') }}" rel="icon">
    ...
    <link
        href="{{ URL::to('https://fonts.googleapis.com/css?family=Open+Sans:300,300i,400,400i,600,600i,700,700i|Nunito:300,300i,400,400i,600,600i,700,700i|Poppins:300,300i,400,400i,500,500i,600,600i,700,700i') }}"
        rel="stylesheet">
    ...
    <!--<link href="{{ URL::to('aassets/vendor/remixicon/remixicon.css') }}" rel="stylesheet">-->
    <link href="{{ URL::to('assets/vendor/simple-datatables/style.css') }}" rel="stylesheet">

    <!-- Template Main CSS File -->
    <link href="{{ URL::to('assets/css/style copy.css') }}" rel="stylesheet">
...
<body>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow messages">
                        ...
                        <li class="message-item">
                            <a href="#">
                                <img src="{{ URL::to('assets/img/messages-1.jpg') }}" alt=""
                        ...
                        <li class="message-item">
                            <a href="#">
                                <img src="{{ URL::to('assets/img/messages-2.jpg') }}" alt=""
                                    class="rounded-circle">
                                <div>
                                    <h4>Anna Nelson</h4>
                                    <p>Velit asperiores et ducimus soluta repudiandae labore officia est ut...</p>
                        ...
                        <li class="message-item">
                            <a href="#">
                                <img src="{{ URL::to('assets/img/messages-3.jpg') }}" alt=""
                                    class="rounded-circle">
                                <div>
                                    <h4>David Muldon</h4>
                                    <p>Velit asperiores et ducimus soluta repudiandae labore officia est ut...</p>
    ...
    @yield('content')
    <footer>
        <p>Copyright © <?php echo date('Y'); ?> Financial Guardian.</p>
    </footer>
